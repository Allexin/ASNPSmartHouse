...
## Пакет LOG
0x03 0x00 <data length+2> 0x00 0x02 <data> 0x06  
Пакет с высоким приоритетом(0x03), широковещательный(0x00), data length+2 байт данных, служебные команды(0x00), команда LOG(0x02), data - данные лога, контрольная сумма(0x06)  
