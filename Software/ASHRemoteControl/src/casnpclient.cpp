...
sDeviceInfo::sDeviceInfo(uint8_t setAddr, eDeviceType setType, uint8_t setChannel, QString setCategory, QString setName):
    address(setAddr),
    type(setType),
    channel(setChannel)
{
    name = setName.isEmpty()?deviceTypeToString(type)+"["+QString::number(address)+"]":setName;
...
{
    m_AvailableDevices.push_back(sDeviceInfo(21,eDeviceType::GATE,0, "Зеленая комната","Большая ставня"));        //большое
    m_AvailableDevices.push_back(sDeviceInfo(22,eDeviceType::GATE,0, "Зеленая комната","Ставня на дорогу"));        //маленьбкое рядом с большим
    m_AvailableDevices.push_back(sDeviceInfo(23,eDeviceType::GATE,0, "Зеленая комната","Ставня на боярышник"));        //угловое улица
    m_AvailableDevices.push_back(sDeviceInfo(24,eDeviceType::GATE,0, "Чердак","Ставня на дорогу"));        //чердак
    m_AvailableDevices.push_back(sDeviceInfo(25,eDeviceType::GATE,0, "Зеленая комната","Ставня Лены"));        //улица

    m_AvailableDevices.push_back(sDeviceInfo(1,eDeviceType::DMX_DIMMER,0,"Детская","Белый")); //детская
    m_AvailableDevices.push_back(sDeviceInfo(1,eDeviceType::DMX_DIMMER,1,"Детская","Красный"));
    m_AvailableDevices.push_back(sDeviceInfo(1,eDeviceType::DMX_DIMMER,2,"Детская","Зеленый"));
    m_AvailableDevices.push_back(sDeviceInfo(1,eDeviceType::DMX_DIMMER,3,"Детская","Синий"));

    m_AvailableDevices.push_back(sDeviceInfo(10,eDeviceType::DMX_DIMMER,0,"Кухня","Свет")); //кухня

    m_AvailableDevices.push_back(sDeviceInfo(12,eDeviceType::GATE,0,"Детская","Ставни"));        //детская
    ...
    m_AvailableDevices.push_back(sDeviceInfo(11,eDeviceType::DMX_DIMMER,2,"Зеленая комната","Свет над Леной"));
